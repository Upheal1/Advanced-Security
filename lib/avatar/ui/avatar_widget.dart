                  ...
                  child: RepaintBoundary(
                    child: Stack(
                      ...
                      children: [
                        ...
                        // Keep the bubble within the avatar's width so adjacent Row text
                        // (e.g. AvatarHeader captions) is never covered — wide maxWidth used to
                        // spill sideways before this fix.
...
class _MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final compact = maxWidth < 72;
    final padH = compact ? 6.0 : 12.0;
